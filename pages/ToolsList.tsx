...
const ToolsList = ({ category: initialCategory }: { category?: string }) => {
  ...
  const getTitle = () => {
    if (activeCategory === 'pdf') return "PDF Architect Studio";
    if (activeCategory === 'image') return "Visual Synthesis Lab";
    if (activeCategory === 'docx') return "Docx Word Smith";
    if (activeCategory === 'misc') return "The Utility Drawer";
    return "All Tools";
  };
